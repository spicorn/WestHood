    ...
    >
      ...
      <div className="mt-5 grid gap-3 text-sm sm:grid-cols-2">
        ...
        <div>
          ...
          {instalmentLabel && (
            <p className="text-xs text-muted-foreground">{instalmentLabel}</p>
          )}
        </div>
        <div>
      ...
      <p className="mt-6 rounded-md bg-muted px-3 py-2 text-xs text-muted-foreground">
        This is an official receipt from Westwood College Accounts. Keep for
        your records. For queries contact accounts@westwood.co.zw · +263 242 885
        120.
      </p>
