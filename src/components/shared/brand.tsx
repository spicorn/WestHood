...
export function SchoolCrest({
  ...
  return (
    ...
    >
      ...
      <path
        d="M32 10L48 18V30C48 40 40 48 32 52C24 48 16 40 16 30V18L32 10Z"
        fill="#2D5A3F"
        stroke="#D4A017"
        strokeWidth="2"
      />
  ...
  return (
    <div className={cn("flex items-center gap-3", className)}>
      ...
      <div className="min-w-0">
        <p className="font-display text-lg font-semibold leading-tight text-navy-50 truncate">
          Westwood College
        </p>
        {!compact && (
          <p className="text-[11px] tracking-[0.18em] uppercase text-gold-400/90">
            Visus Manifestus.
          </p>
        )}
      </div>
