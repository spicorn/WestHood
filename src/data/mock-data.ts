...
export const absenceRequests: AbsenceRequest[] = [
  {
    ...
    studentId: 'stu-kelvin',
    parentId: 'par-rudo',
    parentName: 'Rudo Mutasa',
    startDate: '2026-07-09',
    endDate: '2026-07-11',
    reason: 'Flu — doctor advised rest. Medical note available on request.',
    status: 'pending',
    submittedAt: '2026-07-11T18:00:00',
  },
  {
    id: 'abs-2',
    studentId: 'stu-tariro',
    ...
    endDate: '2026-06-20',
    reason: 'Family funeral (morning only).',
    status: 'approved',
    submittedAt: '2026-06-19T20:10:00',
    reviewedBy: 'st-chipo',
    reviewedAt: '2026-06-20T07:45:00',
    reviewNote: 'Noted — marked excused.',
  },
]
...
export const messageThreads: MessageThread[] = [
  {
    id: 'mt-1',
    subject: 'Re: Fee Payment Reminder — Term 2',
    noticeId: 'n5',
    studentId: 'stu-kelvin',
    participantIds: ['u-parent', 'u-admin'],
    participantNames: { 'u-parent': 'Rudo Mutasa', 'u-admin': 'Tendai Moyo' },
    createdAt: '2026-07-08T09:30:00',
    updatedAt: '2026-07-08T11:15:00',
    lastPreview: 'We can settle the balance by EcoCash this week.',
  },
  {
    id: 'mt-2',
    subject: 'Homework catch-up — Kelvin',
    studentId: 'stu-kelvin',
    participantIds: ['u-parent', 'u-staff'],
    participantNames: { 'u-parent': 'Rudo Mutasa', 'u-staff': 'Chipo Ncube' },
    createdAt: '2026-07-11T16:20:00',
    updatedAt: '2026-07-12T08:05:00',
    lastPreview: 'Thank you — he will submit by Friday.',
  },
]
...
export const chatMessages: ChatMessage[] = [
  {
    ...
    threadId: 'mt-1',
    senderId: 'u-parent',
    senderName: 'Rudo Mutasa',
    senderRole: 'parent',
    body: 'Thank you for the reminder. We can settle Kelvin\'s outstanding balance by EcoCash this week — please confirm the merchant code.',
    sentAt: '2026-07-08T09:30:00',
    readBy: ['u-parent', 'u-admin'],
  },
  {
    id: 'msg-2',
    threadId: 'mt-1',
    ...
    senderRole: 'admin',
    body: 'Merchant code is WWCOLLEGE. Reply here once paid and Accounts will match the receipt.',
    sentAt: '2026-07-08T11:15:00',
    readBy: ['u-admin'],
  },
  {
    id: 'msg-3',
    threadId: 'mt-2',
    senderId: 'u-staff',
    senderName: 'Chipo Ncube',
    senderRole: 'staff',
    body: 'Kelvin still has Quadratic Equations Set B marked missing. Could you please check he has the worksheet?',
    sentAt: '2026-07-11T16:20:00',
    readBy: ['u-staff', 'u-parent'],
  },
  {
    id: 'msg-4',
    threadId: 'mt-2',
    ...
    senderName: 'Rudo Mutasa',
    senderRole: 'parent',
    body: 'Thank you — he will submit by Friday.',
...
export const auditLog: AuditLogEntry[] = [
  {
    ...
    actorId: 'u-admin',
    actorName: 'Tendai Moyo',
    actorRole: 'admin',
    summary: 'Recorded cash payment for Tariro Mutasa — Term 2 instalment 3',
    entityType: 'payment',
    entityId: 'pay-3',
  ...
  },
  {
    ...
    actorName: 'Tendai Moyo',
    actorRole: 'admin',
    summary: 'Published Term 2 Mid-Term report for Kelvin Mutasa',
    entityType: 'report',
    entityId: 'rpt-stu-kelvin-t2',
  ...
  },
  {
    ...
    action: 'grade_upsert',
    actorId: 'u-staff',
    actorName: 'Chipo Ncube',
    actorRole: 'staff',
    summary: 'Updated Maths mark for Kelvin Mutasa (Term 2 Mid-Term)',
    entityType: 'grade',
    entityId: 'gr-kelvin-maths',
    createdAt: '2026-06-13T10:30:00',
    meta: { subject: 'Mathematics', mark: '55' },
  },
]

export const admissionEnquiries: AdmissionEnquiry[] = [
  {
    id: 'adm-1',
    studentName: 'Anesu Choto',
    dob: '2011-04-12',
    gender: 'M',
    applyingForClassId: 'c-f1',
    guardianName: 'Patience Choto',
    guardianEmail: 'patience.choto@email.co.zw',
    guardianPhone: '+263 77 612 4401',
    relationship: 'Mother',
    stage: 'enquiry',
    notes: 'Interested in boarding from Form 1. Visited campus 5 July.',
    source: 'Open Day',
  ...
  {
    id: 'adm-2',
    studentName: 'Rutendo Moyo',
    dob: '2009-09-01',
    gender: 'F',
    applyingForClassId: 'c-f3',
    guardianName: 'Gift Moyo',
    guardianEmail: 'gift.moyo@email.co.zw',
    guardianPhone: '+263 77 612 4402',
    relationship: 'Father',
    stage: 'application',
    notes: 'Transfer from another Harare day school. Strong Maths/Science.',
    source: 'Website',
  ...
  {
    id: 'adm-3',
    studentName: 'Tafadzwa Banda',
    dob: '2008-02-22',
    gender: 'M',
    applyingForClassId: 'c-f4',
    guardianName: 'Lydia Banda',
    guardianEmail: 'lydia.banda@email.co.zw',
    guardianPhone: '+263 77 612 4403',
    relationship: 'Mother',
    stage: 'offer',
    notes: 'Offer letter issued 8 July. Awaiting acceptance deposit.',
    source: 'Referral',
  ...
  {
    id: 'adm-4',
    studentName: 'Nyasha Gumbo Jr',
    dob: '2007-11-30',
    gender: 'F',
    applyingForClassId: 'c-l6',
    guardianName: 'Tendai Gumbo',
    guardianEmail: 'tendai.gumbo@email.co.zw',
    guardianPhone: '+263 77 612 4404',
    relationship: 'Father',
    stage: 'accepted',
    notes: 'Accepted Sciences stream. Enrolment paperwork due before Term 3.',
    source: 'Open Day',
  ...
  {
    id: 'adm-5',
    studentName: 'Sean Phiri',
    dob: '2010-07-07',
    gender: 'M',
    applyingForClassId: 'c-f2',
    guardianName: 'Grace Phiri',
    guardianEmail: 'grace.phiri@email.co.zw',
    guardianPhone: '+263 77 612 4405',
    relationship: 'Mother',
    stage: 'enrolled',
    notes: 'Enrolled for Term 2 start. Student record linked.',
    source: 'Walk-in',
    createdAt: '2026-04-01T08:00:00',
    updatedAt: '2026-05-02T10:00:00',
    enrolledStudentId: 'stu-001',
  },
]
...
notifications.push(
  {
    ...
    body: 'Rudo Mutasa submitted an absence note for Kelvin (9–11 July).',
    time: '5 hr ago',
    read: false,
  ...
  },
  {
    ...
    body: 'Rudo Mutasa replied on Fee Payment Reminder thread.',
    time: '1 day ago',
    read: false,
    href: '/admin/messages',
  },
  {
    ...
    body: '1 offer awaiting acceptance — Tafadzwa Banda (Form 4).',
    time: '2 days ago',
    read: true,
