      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center p-4">
        ...
        >
          <div className="mb-8 text-center">
            ...
            <p className="mt-1 text-sm tracking-[0.25em] uppercase text-gold-400">
              Visus Manifestus.
            </p>
          ...
          <div className="rounded-xl border border-white/10 bg-white/95 p-6 shadow-2xl backdrop-blur">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="identifier"
                    className="pl-9"
                    placeholder="admin@westwood.co.zw"
            ...
            <div className="mt-5 rounded-md border border-dashed border-navy-200 bg-navy-50/60 p-3 text-xs text-muted-foreground">
              <p className="font-semibold text-navy-700 mb-1">
                Demo accounts as of now!!
              </p>
              <p>
                admin / staff / parent / student — password matches the username
              </p>
            </div>
          </div>
        </motion.div>
      ...
      <Dialog open={forgotOpen} onOpenChange={setForgotOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Password resets are handled by the school administrator. Please
              contact the IT office or front desk.
            </DialogDescription>
          </DialogHeader>
          <div className="rounded-md bg-muted p-3 text-sm">
            <p className="font-medium">Westwood College IT Support</p>
            <p className="text-muted-foreground">
              it@westwood.co.zw · +263 242 885 120
            </p>
          </div>
          <DialogFooter>
