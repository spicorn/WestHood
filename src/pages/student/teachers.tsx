...
export default function StudentTeachersPage() {
  ...
  const teacherGroups = useMemo(() => {
    ...
    for (const subject of classSubjects) {
      const slot = timetable.find((t) => t.classId === student.classId && t.subjectId === subject.id)
  ...
  }, [classSubjects, timetable, staff, student.classId])

  return (
    <div>
      <PageHeader title="My Teachers" description="Subject teachers assigned to your class this term." />
